    ...
    <div class="column-wrapper">
      ...
      <div class="column-two column-next">
        <div class="column-right">
          ...
          <ul>
            <li>Tutorial: <a href="http://www.ensembl.org/info/docs/api/variation/variation_tutorial.html#structural">Accessing structural variation data with the Variation API</a></li>
          </ul>
          <h2>Reference materials</h2>
          <ul>
            <li><a href="http://www.ensembl.org/info/genome/variation/index.html">Ensembl variation documentation portal</a></li>
          </ul>
        </div>
      </div>
    </div>

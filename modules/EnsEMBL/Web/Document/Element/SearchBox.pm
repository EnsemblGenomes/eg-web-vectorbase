...
### Generates small search box (used in top right corner of pages)
    ...
    return qq{
      <div id="block-search-form">
        <form id="vb-search" method="get" action="$search_url">
          ...
          <input class="vb-search-keywords" name="q" value="" size="25" type="text" maxlength="128" placeholder="Enter search terms" title="Enter the terms you wish to search for." />
